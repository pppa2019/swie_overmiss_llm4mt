...
class ModelArguments:
    ...
    local_test: Optional[bool] = field(default=False)
...
def main():
    ...
    if model_args.model_name_or_path:
        ...
        if model_args.origin_setting:
            ...
            model_class = InsEmbLlamaForCausalLM
        # use just for test
        if model_args.local_test:
        ...
        with CaptureLogger(tok_logger) as cl:
            ...
            if "prefix" in column_names:
                ...
                for p in prefix:
                    ...
                    #     instruction.append(p.split("\n\n### Input:")[0].split("### Instruction:")[-1].strip())
                    # else:
                    #     instruction.append(p.split("\n\n### Response:")[0].split("### Instruction:")[-1].strip())
    ...
    if model_args.only_optimize_layers:
        for name, param in model.named_parameters():
            if "embed" in name and model_args.freeze_embed:
